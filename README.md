...
**Software Developer, Jarvis (2020-present)**: Developed and implemented a comprehensive Linux cluster monitoring system using Bash, Docker, and PostgreSQL,automating real-time data collection with crontab and optimizing database management for efficient resource utilizationand capacity planning. .
