...
public class QuoteDAO implements CrudDAO<Quote, ID> {
    ...
    public Quote findBySymbol(String symbol) {
        try (PreparedStatement statement = this.connection.prepareStatement(SELECT_BY_SYMBOL)) {
            ...
            logger.error("ERROR: failed to find quote by symbol", e);
        }
        return null;
    }
    ...
    public List<Quote> findAll() {
        try (PreparedStatement statement = this.connection.prepareStatement(SELECT_ALL)) {
            ...
            logger.error("ERROR: failed to find all quotes", e);
        }
        return null;
    }
    ...
    public Quote update(Quote dto) {
        try (PreparedStatement statement = this.connection.prepareStatement(UPDATE)) {
            ...
            logger.error("ERROR: failed to update quote", e);
        }
        return null;
    }
    ...
    public void delete(ID id) {
        try (PreparedStatement statement = this.connection.prepareStatement(DELETE)) {
            ...
            logger.error("ERROR: failed to delete quote by id", e);
        }
    }
    ...
    public void delete(String symbol) {
        try (PreparedStatement statement = this.connection.prepareStatement(DELETE_SYMBOL)) {
            ...
            logger.error("ERROR: failed to delete quote by symbol", e);
        }
    }
}
